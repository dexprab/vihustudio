...
const ContextPanel=(function(){
  ...
  const ADD_ART={
    ...
    // My Garden — a potted plant, the thing actually inside
    // (Decision 27). It was a shelf of books for as long as this was
    // called My Library, and the label changed without the picture,
    // which left the one tile in the grid arguing with its own name.
    library:'<svg viewBox="0 0 32 32" width="30" height="30"><path d="M16 21V9.6" fill="none" stroke="#6E8F6A" stroke-width="2" stroke-linecap="round"/><path d="M16 16.2c-1.3-4-4.9-5.4-7.7-4.9-.6 3.6 2 6.6 7.7 4.9z" fill="#8FAF87"/><path d="M16 12.2c1.3-4.2 5-5.6 7.9-5-.6 3.7-2.1 6.8-7.9 5z" fill="#5BBE97"/><circle cx="16" cy="7.4" r="2.9" fill="#FFD84D"/><circle cx="16" cy="7.4" r="1.1" fill="#E2A93C"/><path d="M8.4 20.4h15.2l-1.7 7.2a1.8 1.8 0 01-1.8 1.4h-8.2a1.8 1.8 0 01-1.8-1.4z" fill="#E08B62"/><rect x="6.9" y="17.4" width="18.2" height="3.6" rx="1.6" fill="#F2A87F"/></svg>',
