...
- Fill style and alignment always shows solid and center as selected even if i change them. the effect is there on object but the state of button does not change.<img width="215" height="151" alt="image" src="https://github.com/user-attachments/assets/4965d99c-d10d-47f0-837e-87a4169998d6" />
- Change right pane to this . <img width="314" height="494" alt="image" src="https://github.com/user-attachments/assets/e549d958-6b32-4ca9-94fb-5248fc2301a3" /> Default state of add something should be open.
- Add image option also in background . 
