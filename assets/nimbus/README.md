...
Nimbus's Companion Package for the Companion Engine (`js/companionEngine.js`)
— a Dream Sprite, one of two Story Companions seeded by the Companion Canon
...
real pool of more than one entry to choose from. See `../quill/` for the
other.
